...
#
#             if test_method == 3:
#                 max_values = correlation_matrix * max_values_mask / torch.maximum(torch.sqrt(partical), torch.ones_like(partical) * 1e-12)
#             else:
#                 max_values = correlation_matrix * max_values_mask / torch.maximum(partical, torch.ones_like(partical) * 1e-12)
